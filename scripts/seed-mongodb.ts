...
function generateAdvertisements(userIds: string[]): any[] {
  ...
  ads.push({
    ...
    db_category: 'realty',
    upload: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
      {
        id: 1,
        uploads: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=600&fit=crop',
        sort_order: 2000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    db_category: 'realty',
    upload: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Kyrenia.lng, CITIES.Kyrenia.lat],
    db_category: 'avto',
    upload: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
      {
        id: 1,
        uploads: 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=800&h=600&fit=crop',
        sort_order: 2000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Nicosia.lng, CITIES.Nicosia.lat],
    db_category: 'avto',
    upload: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
      {
        id: 1,
        uploads: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=800&h=600&fit=crop',
        sort_order: 2000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Nicosia.lng, CITIES.Nicosia.lat],
    db_category: 'work',
    upload: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Kyrenia.lng, CITIES.Kyrenia.lat],
    db_category: 'work',
    upload: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    upload: 'https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Kyrenia.lng, CITIES.Kyrenia.lat],
    db_category: 'services',
    upload: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    upload: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    upload: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Famagusta.lng, CITIES.Famagusta.lat],
    db_category: 'electronics',
    upload: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Nicosia.lng, CITIES.Nicosia.lat],
    db_category: 'fashion',
    upload: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    upload: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  ads.push({
    ...
    geo_indexed: [CITIES.Famagusta.lng, CITIES.Famagusta.lat],
    db_category: 'free',
    upload: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=800&h=600&fit=crop',
    full_upload: [
      {
        id: 0,
        uploads: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=800&h=600&fit=crop',
        sort_order: 1000,
        full_upload: 1,
      },
    ],
  ...
  return [
    {
      ...
      geo_indexed: [CITIES.Kyrenia.lng, CITIES.Kyrenia.lat],
      db_category: 'electronics',
      upload: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=800&h=600&fit=crop',
      full_upload: [],
    ...
    },
    {
      ...
      geo_indexed: [CITIES.Nicosia.lng, CITIES.Nicosia.lat],
      db_category: 'house_garden',
      upload: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&h=600&fit=crop',
      full_upload: [],
    ...
    },
    {
      ...
      geo_indexed: [CITIES.Famagusta.lng, CITIES.Famagusta.lat],
      db_category: 'fashion',
      upload: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=800&h=600&fit=crop',
      full_upload: [],
